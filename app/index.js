...
emarket.db.stores = require('./emarket/db/storenames');

var emarket_electron = {};
emarket_electron.transactions = require('./emarket_electron/transactions');
emarket_electron.fe_config = require('./emarket_electron/fe_config');

const marketbindings = require('./marketbindings');

const appbindings = require('./appbindings');
...
function createWindow() {
  ...
  mainWindow.loadURL(`file://${__dirname}/../opensource/frontend/dist/index.html`)
