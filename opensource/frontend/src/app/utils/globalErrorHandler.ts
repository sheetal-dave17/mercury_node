...
export class GlobalErrorHandler implements ErrorHandler {
  ...
  private error;
  handleError(error) {
    // this.http.sendReport(this.extractData(error));
    // do something with the exception
    console.error('Error', this.extractData(error));
  ...
  .nose {
    ...
    border-color: #E6E6C2 transparent transparent transparent;
  }
  ...
  .foot1{
    ...
    position: relative;
    left: 6vmin;
    box-shadow: 3vmin 0vmin 0vmin 0vmin #E6E6C2;
    }
  ...
  .branch {  
    ...
    height: 0;
    border-style: solid;
    border-color: transparent transparent transparent #949483;
    transform: translateX(-50%);
    left: 50%;
  }
  ...
  <div style="
      ...
      padding-top: 50px;
  ">
      <h2>Unavailable at this moment</h2>
      <p>This content currently is in development process. Please reload the application to continue your process. We are very sorry :)</p>
  </div>
  <div class="owl-cage">
  <div class="owl">
                  <div class="wing1"></div>
  ...
  private extractData(res: TypeError) {
    try {
      return res.message;
      // return res.json();
    } catch (e) {
